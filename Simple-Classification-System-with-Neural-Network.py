...
for iter in range(10000):
    l0=x#4x6
    l1=nonlin(np.dot(l0,syn0))#4x8
    l2=nonlin(np.dot(l1,syn1))#4x10
    l3=nonlin(np.dot(l2,syn2))#4x2
    l3_error=y-l3#4x2
    l3_delta=l3_error*nonlin(l3,True)#4x2
    l2_error=np.dot(l3_delta,syn2.T)#4x10
    l2_delta=l2_error*nonlin(l2,True)#4x10
    l1_error=np.dot(l2_delta,syn1.T)#4x8
    l1_delta=l1_error*nonlin(l1,True)#4x8
